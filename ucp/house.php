...
<body>
	<div class="container">
		...
		<div style="padding: 10px 20px;">
			<div class="header">
				<div class="title">
					<img src="img/logo.png" height="40px" style="float: left;"><h3>PanaFive™</h3><span style="line-height: 40px; font-size: 12px; padding-left: 10px;">Maisons</span>
				</div>
			...
			<div class="body">
				<div style="display: block; width: 100%;">
					<div class="col-7 stat" style="float: left;">
						<span>Maison 1</span>
						<div style="padding: 10px 5px; font-size: 14px;">
							<span>Proprietaire: Jack Huner</span>
							<span>Proprietaire: Jack Huner</span>
							<span>Proprietaire: Jack Huner</span>
							<span>Proprietaire: Jack Huner</span>
							<span>Proprietaire: Jack Huner</span>
					...
					<div class="col-4 stat" style="float: right; height: 210px; padding: 0;">
						<img src="img/house.png" style="height: 100%; width: 100%;">
					</div>
					<a href="index.php">
