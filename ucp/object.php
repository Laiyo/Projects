...
<body>
	<div class="container">
		...
		<div style="padding: 10px 20px;">
			<div class="header">
				<div class="title">
					<img src="img/logo.png" height="40px" style="float: left;"><h3>PanaFive™</h3><span style="line-height: 40px; font-size: 12px; padding-left: 10px;">Objets Possédés</span>
				</div>
			...
			<div class="body">
				<div style="display: block; width: 100%;">
					<div class="col-12 stat" style="float: left;">
						<span>Weed</span>
						<div style="padding: 10px 5px; font-size: 14px;">
							<span><img class="img" src="img/icon/weed.png" height="30px" style="float: left;"> 10</span>
						</div>
					</div>
				</div>
			</div>	
